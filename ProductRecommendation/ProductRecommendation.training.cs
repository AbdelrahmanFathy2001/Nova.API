    ...
    public partial class ProductRecommendation
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(@"userId", @"userId")      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(labelColumnName:@"rating",matrixColumnIndexColumnName:@"userId",matrixRowIndexColumnName:@"productId"));
